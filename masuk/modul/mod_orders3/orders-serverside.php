...
if ($_GET['action'] == "table_data") {
    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            ...
            <a href='modul/mod_orders/tampil_orders.php?id=$value[kd_trbmasuk]' target='_blank' title='EDIT' class='btn btn-primary btn-xs'>&nbsp;<i class='glyphicon glyphicon-print'></i>&nbsp;</a>";
            $data[] = $nestedData;
            $no++;
        }
    }
