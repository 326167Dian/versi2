...
if ($module=='orders' AND $act=='input_trbmasuk'){
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE kdbm SET stt_kdbm = 'OFF' WHERE id_admin = '$_SESSION[id_admin]' AND id_resto = 'pesan' AND kd_trbmasuk = '$_POST[kd_trbmasuk]'");
