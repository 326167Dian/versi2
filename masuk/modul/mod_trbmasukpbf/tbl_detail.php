...
<div class="box-body table-responsive">
    <table id="example5" class="table table-condensed table-bordered table-striped table-hover">
        ...
        $carabayar = $rf['carabayar'];**/
            ...
            $sumprice1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT ttl_trbmasuk,dp_bayar,sisa_bayar FROM trbmasuk WHERE kd_trbmasuk='$kd_trbmasuk'");
            $ttlprice1 = mysqli_fetch_array($sumprice1);
